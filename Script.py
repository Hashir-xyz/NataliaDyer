...
𝙷𝙴𝚁𝙴 𝙸𝚂 𝚃𝙷𝙴 𝙷𝙴𝙻𝙿 𝙵𝙾𝚁 𝙼𝚈 𝙲𝙾𝙼𝙼𝙰𝙽𝙳𝚂."""
    ABOUT_TXT = """ ⇢  ᴍʏ ɴᴀᴍᴇ 🍁 : <a href='https://t.me/NataliaTG_bot'>ɴᴀᴛᴀʟɪᴀ ᴅʏᴇʀ😍</a>
    
⇢ ᴅᴇᴠᴏʟᴏᴘᴇʀ👨🏼‍💻: <a href='https://t.me/Edizon1'>ᴇᴅɪᴢᴏɴ</a>
...
<b>NOTE:</b>
1. Natalia should have admin privillage.
...
- Natalia Supports both url and alert inline buttons. 
 
<b>NOTE:</b>
1. Telegram will not allows you to send buttons without any content, so content is mandatory.
2. Natalia supports buttons with any telegram media type.
3. Buttons should be properly parsed as markdown format

<b>URL buttons:</b>
<code>[Button Text](buttonurl:https://t.me/NataliaTG_bot)</code>
...
<b>NOTE:</b>
these are the extra features of Natalia
